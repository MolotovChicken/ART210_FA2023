...
function setup() {
  ...
  //let i be a variable that will continue to run this code as long as i < 100
  //also serves to create 100 agents (using Agent class) and push to array
  for (let i = 0; i < 100; i++){
